...
def main():
    log_hook_start("SessionEnd", "session-stats-dashboard.py")
    ...
    try:
        ...
        log_debug("SessionEnd", "session-stats-dashboard.py", f"Transcript: {transcript_path}", "INFO")

        if not transcript_path.exists():
            log_debug("SessionEnd", "session-stats-dashboard.py", "Transcript not found", "SKIP")
            log_hook_end("SessionEnd", "session-stats-dashboard.py", True)
            sys.exit(0)

        # Parse and display stats
        log_debug("SessionEnd", "session-stats-dashboard.py", "Parsing transcript...", "INFO")
        stats = parse_transcript(transcript_path)

        log_debug("SessionEnd", "session-stats-dashboard.py", f"Stats: {stats['user_prompts']} prompts", "INFO")
        log_debug("SessionEnd", "session-stats-dashboard.py", "Displaying dashboard", "OUTPUT")
        ...
        log_debug("SessionEnd", "session-stats-dashboard.py", f"ERROR: {e}", "ERROR")
        log_hook_end("SessionEnd", "session-stats-dashboard.py", False)
