...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  // Add click handlers for skill action buttons
  ...
  // Add click handlers for server action buttons
  document.querySelectorAll("[data-server-action]").forEach(btn => {
    btn.addEventListener("click", (e) => {
      ...
      const command = btn.dataset.copyCommand;
  ...
  // Add click handlers for generic copy buttons
  document.querySelectorAll("[data-copy-command]:not([data-server-action])").forEach(btn => {
    btn.addEventListener("click", (e) => {
