...
| **~/.claude/skills/ orphelines** | **2** | **🔴 À MIGRER** |
| `_référentiels` (guides) | 8 | À convertir |
| **TOTAL À MIGRER** | **64** | |

---

## 🔴 Skills orphelines dans ~/.claude/skills/ (2)
...
> **Note:** Les 3 skills Notion PKM (notion-github-enhance-note, notion-inbox-to-github, notion-route-entry) ont été consolidées dans le projet `2025.09 Notion Uploader` (`.claude/skills/`).
...
- **Total skills dispersées**: 62 (projets) + 2 (orphelines) = **64**
