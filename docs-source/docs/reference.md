...
| `skill-triggers.json` | `registry/` | Triggers des skills |
| `hooks-registry.json` | `registry/` | Registre des hooks |
| `mcp-registry.json` | `registry/` | Registre des MCPs |
| `projects-registry.json` | `registry/` | Registre des projets |
| `sync-config.json` | `registry/` | Config de synchronisation |
